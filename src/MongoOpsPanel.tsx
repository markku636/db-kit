...
import { IconButton, Select, ModalViewControls, useModalView } from "./ui/index";
...
export default function MongoOpsPanel({ connId, connName, database, readonly, onClose }: {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
      <div className={`bg-elevated w-[900px] max-w-[95vw] h-[80vh] flex flex-col rounded-lg border border-fg/10 shadow-2xl ${shellClass}`}
